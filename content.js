...
const SITE_CONTENT = {
  ...
  modalDetails: {
    "hr_basic": {
        ...
        "content": "<div class=\"space-y-4\"><h4 class=\"text-brand-600\">📚 Key Learning: HR 체계의 이해</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>📌 직무관리: 직무분석 절차, 직무기술서/명세서 작성, 직무평가</li><li>📌 채용관리: 역량 중심 면접(BEI) 설계 및 채용 브랜딩 변화</li><li>📌 성과관리: MBO vs OKR, 성과책임(Accountability) 규명</li><li>📌 보상관리: 직무급/역할급 설계 논리, Merit Increase 매트릭스</li><li>📌 노동법: 근로시간, 연차, 모성보호, 퇴직 관리 등 필수 법규</li></ul><h4 class=\"text-brand-600\">💡 My Perspective: 인사이트</h4><h4 class=\"text-brand-600\">직무 기준(Job Value)이 HR의 시작점이다</h4><p class=\"text-slate-600 text-sm leading-relaxed\">직무 가치가 불명확하면 채용-평가-보상의 논리가 모두 어긋남. '사람'이 아닌 '역할'에 집중하는 것이 공정성의 핵심.</p><h4 class=\"text-brand-600\">보상은 '금액'보다 '설득 논리'가 중요하다</h4><p class=\"text-slate-600 text-sm leading-relaxed\">구성원은 결과값 자체보다 \"왜 내가 이 평가/보상을 받았는가\"에 대한 설명에 반응함. HR은 이 논리를 설계하고 전달하는 역할.</p><h4 class=\"text-brand-600\">리스크 관리는 '절차적 정당성'에서 온다</h4><p class=\"text-slate-600 text-sm leading-relaxed\">퇴직, 징계 등 민감 이슈는 결과보다 '사전 예고-소명 기회-일관된 기준'이라는 절차를 준수했는가가 법적/조직적 리스크를 결정함.</p><h4 class=\"text-brand-600\">🚀 Next Step: 현업 적용 계획</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>✅ 직무 기반 HR 체계 재점검 — 현행 직무기술서의 실효성 점검 및 채용 JD와의 정합성 검증</li><li>✅ 보상 수용성 강화 모델링 — 평가 등급별 인상률 시뮬레이션(Top/Mid/Low) 및 커뮤니케이션 가이드 마련</li><li>✅ 노무 리스크 대응 매뉴얼화 — 반복되는 이슈(연차, 근로시간, 도급) 중심의 Case Study 루틴화</li></ul></div>"
    },
    "tableau": {
        "title": "Tableau Bootcamp 29기",
        "subtitle": "대시보드 제작 실습 및 Prep 데이터 정렬 학습",
        "content": "<div class=\"space-y-4\"><h4 class=\"text-brand-600\">📊 Key Learning: 기능과 활용</h4><h4 class=\"text-brand-600\">1. 시각화 기초 &amp; 차트</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>차원 vs 측정값, 집계 원리 이해</li><li>이중축/콤보 차트, 트리맵, 산점도 구현</li><li>맵 시각화(레이어/필터) 및 대시보드 배치</li></ul><h4 class=\"text-brand-600\">2. 계산식 &amp; 고급 분석</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>LOD(FIXED)를 활용한 전국 기준 비율 산출</li><li>테이블 계산(전일 대비 등락, 구성비)</li><li>매개변수를 활용한 동적 측정값 전환</li></ul><h4 class=\"text-brand-600\">3. 특수 차트 &amp; 디자인</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>도넛, 워터폴(수익 누계), 범프(순위 변동)</li><li>퍼널, 간트 차트(영업시간 시각화)</li><li>대시보드 디자인 10원칙 적용 (Z형 배치 등)</li></ul><h4 class=\"text-brand-600\">4. 데이터 전처리 (Prep)</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>Union/Join을 통한 데이터 결합 및 정제</li><li>값 그룹핑 및 불필요 필드 정리</li><li>분석용 데이터셋 출력 및 자동화</li></ul><h4 class=\"text-brand-600\">💡 My Perspective: HR 데이터 관점</h4><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>01 '감'이 아닌 '근거' 기반의 결정: 인사 운영을 근태/채용 Pipeline/인력 투입 현황 등 실시간 데이터 모니터링 체계로 전환 가능함.</li><li>02 평균의 함정 탈피: 특정 부서나 공정의 과로 위험(Outlier)을 박스플롯 등으로 즉시 시각화하여 선제적 조치 가능.</li><li>03 전달력 있는 커뮤니케이션: 경영진과 현장 관리자가 직접 필터를 조작하며 인사이트를 얻는 대시보드 구축이 핵심.</li></ul><h4 class=\"text-brand-600\">🚀 Next Step: 현업 적용 계획</h4><div class=\"overflow-hidden border border-slate-200 rounded-xl\"><table class=\"w-full text-sm text-left text-slate-600\"><thead class=\"bg-slate-50 text-slate-700 font-bold border-b border-slate-200\"><tr><th class=\"px-4 py-3\">단계</th><th class=\"px-4 py-3\">실행 목표</th></tr></thead><tbody class=\"divide-y divide-slate-100\"><tr><td class=\"px-4 py-3\">1단계: 모니터링</td><td class=\"px-4 py-3\">부서/공정별 근태 편차 및 위험 구간(52시간 임계) 자동 시각화</td></tr><tr><td class=\"px-4 py-3\">2단계: 인력 매칭</td><td class=\"px-4 py-3\">정원(TO) vs 실 투입 인력(직영/도급) 차이 분석 및 경고 시스템</td></tr><tr><td class=\"px-4 py-3\">3단계: 채용 분석</td><td class=\"px-4 py-3\">채용 단계별(서류-면접-입사) 전환율 Funnel 및 병목 구간 시각화</td></tr><tr><td class=\"px-4 py-3\">4단계: 운영 자동화</td><td class=\"px-4 py-3\">HR 원천 데이터 표준화 및 Tableau Prep을 활용한 전처리 자동화</td></tr></tbody></table></div></div>"
    }
},
