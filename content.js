...
const SITE_CONTENT = {
  ...
  careerHistory: [
    {
        ...
        "position": "매니저",
        "period": "2026.06 ~ 재직 중",
        "summary": "조직문화, 교육 담당, 채용 지원 담당, 기업 AX 담당",
        "details": [
            "온보딩 프로그램 운영",
            "기업 활동 블로그 운영",
            "팀 인터뷰 아티클 발행",
            "기업 리더십 관련 4컷만화, 숏츠 영상 등 제작, 발행",
            "도서 지원, 전사 교육비 관리 등 교육 운영",
            "개발직군, 비개발직군 포함 전사 채용운영 지원",
            "그리팅 ATS 활용 채용전형 관리 운영",
            "리멤버, 원티드 등 채용 플랫폼 활용",
            "아웃바운드 채용, 다이렉트 소싱 지원",
            "처우 협의 제외 전 입사일정 관리",
            "전사 AX 관련 기업문화 정착 카드뉴스 발행",
            "인사 HR, 채용, 조직문화 분야 자동화 담당",
            "(성과는 아직 없음 - 입사 1개월 미만)"
        ],
        "employmentType": "계약직",
        "status": "재직 중",
  ...
  activitiesList: [
    ...
    },
    {
        ...
        "rank": "최우수상 수상",
        "icon": "🏆",
        "content": "<div class=\"space-y-4\"><div class=\"rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600 flex gap-3\"><span class=\"mt-0.5\">⚠️</span><div>활동 상세 내용을 노션 페이지 본문에 직접 작성해주세요.</div></div><p class=\"text-slate-600 text-sm leading-relaxed\"><strong>💡 성과 요약</strong></p><ul class=\"list-disc pl-4 text-sm text-slate-600 space-y-2\"><li>최우수상 수상</li><li>사용자 경험(UX) 개선 모델 제시</li></ul><p class=\"text-slate-600 text-sm leading-relaxed\"><strong>💡 솔루션: 여행 경험의 단순화</strong></p><p class=\"text-slate-600 text-sm leading-relaxed\">수하물/좌석/기내식을 묶은 <strong>'월정액 구독 모델'</strong> 제안</p><p class=\"text-slate-600 text-sm leading-relaxed\"><strong>핵심 역량</strong></p><p class=\"text-slate-600 text-sm leading-relaxed\">비즈니스 모델 설계, 사용자 경험 중심 사고</p></div>"
    }
]
